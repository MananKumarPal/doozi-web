      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-card p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-brand-gray mb-6">
              To exercise these rights, contact us at privacy@doozi.tv. We may verify your request before responding. You may designate an authorized agent to make a request on your behalf where permitted by law.
            </p>
            ...
            <p className="text-brand-gray mb-6">
              To exercise these rights, contact us at privacy@doozi.tv.
            </p>
